...
try{
 ...
 console.log(`PASS: ${engine} opened ${artifact} directly via file://, rendered the mandatory story and title, started gameplay, and attempted no network requests`);await context.close();
