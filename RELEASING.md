...
13,298 / 13,312 bytes
14 bytes free
SHA-256 899ddff0a35c87085cf62f0d4e451732f2c53e4cf7b57dcce60723f434c3d3ec
```
...
The current candidate has **14 bytes free**. Any source change should be treated as a release change and requalified from zero.
...
Because the candidate has 14 bytes of headroom, do not treat even tiny gameplay copy edits as harmless.
...
Do not manually re-compress the archive. At 14 bytes free, a different ZIP tool can easily move the candidate over the limit.
